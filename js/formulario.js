...
const EMAILJS_PUBLIC_KEY = "rou8LvKrhqQxixh8X";
const EMAILJS_SERVICE_ID = "service_i1rdnme";
const EMAILJS_TEMPLATE_ID = "template_z2s2psg";
// Inicializar EmailJS
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      const formData = {
        ...
        servicio: document.querySelector('input[name="servicio"]:checked')
          .value,
        ...
        mensaje:
          document.getElementById("mensaje").value || "Sin mensaje adicional",
      ...
      emailjs
        ...
        .catch(function (error) {
          ...
          alert(
            "❌ Hubo un error al enviar tu cotización. Por favor, intenta nuevamente o contáctanos por WhatsApp."
          );
          submitBtn.disabled = false;
          submitBtn.innerHTML = textoOriginal;
        });
  ...
  function getPrendaSeleccionada() {
    ...
    const prendaSublimacion =
      document.getElementById("prendaSublimacion").value;
