 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Mt._jsonSchemaVersion="firestore/querySnapshot/1.0",Mt._jsonSchema={type:F("string",Mt._jsonSchemaVersion),bundleSource:F("string","QuerySnapshot"),bundleName:F("string"),bundle:F("string")};(function(e,t=!0){Zl(ut),ct(new Ke("firestore",(r,{instanceIdentifier:o,options:c})=>{const h=r.getProvider("app").getImmediate(),y=new Ru(new iu(r.getProvider("auth-internal")),new ou(h,r.getProvider("app-check-internal")),Iu(h,o),h);return c={useFetchStreams:t,...c},y._setSettings(c),y},"PUBLIC").setMultipleInstances(!0)),De(As,bs,e),De(As,bs,"esm2020")})();export{Ke as C,me as F,ut as S,ct as _,Du as a,uo as b,Uu as c,Q as d,vi as e,ga as f,ne as g,Us as h,Tn as i,_a as j,kc as k,xu as l,Fu as m,Mu as o,Ds as p,De as r,Lu as s};
